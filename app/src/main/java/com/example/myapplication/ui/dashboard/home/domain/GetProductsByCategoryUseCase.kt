...
class GetProductsByCategoryUseCase(private val remoteRepo: HomeRemoteRepo) : BaseUseCase<ProductsResponse?, String> {
    override suspend fun invoke(params: String): Result<ProductsResponse?> {
        return remoteRepo.getProductsByCategory(params)
    }
}